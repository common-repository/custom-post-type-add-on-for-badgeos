...
**Note:** You will need to install the free [BadgeOS plugin](http://wordpress.org/extend/plugins/badgeos/ "BadgeOS")&trade; (version 3.0 or higher) to use the BadgeOS Community Add-on. The Plugin was tested up to BadgeOS 3.6.7
...
This plugin was originally developed for the [Academy of International Cooperation](https://www.giz.de/akademie/en/html/index.html) of [GIZ](https://www.giz.de).
...
3. Upload 'Custom Post Type Add-On' to the '/wp-content/plugins/' directory
4. Activate the plugin through the 'Plugins' menu in WordPress

== Screenshots ==

1. Backend view for registering example Custom Post Type Events for BadgeOS achievements.

== Changelog ==

= 1.0.2 =
* Prepare for packaging and distribution. First public release.
